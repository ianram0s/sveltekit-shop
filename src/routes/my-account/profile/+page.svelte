<script lang="ts">
    ...
    import { UserIcon, MailIcon, PhoneIcon, MapPinIcon, CalendarIcon } from '$lib/components/icons';
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        {:else}
                            ...
                            <p class="text-muted-foreground text-sm">Add an address to enable shipping</p>
                        {/if}
                    </div>
                </div>
            {/if}
