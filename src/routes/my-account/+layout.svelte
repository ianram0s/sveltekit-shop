<script lang="ts">
    ...
    import { UserIcon, PackageIcon, HeartIcon, SettingsIcon, LogOutIcon } from '$lib/components/icons';
    ...
    function isActive(href: string): boolean {
        return currentPath === href || (href === '/my-account/profile' && currentPath === '/my-account');
    }
            ...
            <div class="lg:col-span-1">
                <nav class="space-y-2">
                    ...
                    <AlertDialog.Root bind:open={showSignOutDialog}>
                        <AlertDialog.Trigger
                            class="text-muted-foreground hover:text-foreground hover:bg-accent flex w-full cursor-pointer items-center space-x-3 rounded-lg px-4 py-3 text-left transition-all duration-200"
                        >
                        ...
                        <AlertDialog.Content>
                            ...
                            <AlertDialog.Footer>
                                ...
                                <AlertDialog.Action class="cursor-pointer" onclick={handleSignOut}
                                    >Sign Out</AlertDialog.Action
                                >
                            </AlertDialog.Footer>
                        </AlertDialog.Content>
                    </AlertDialog.Root>
