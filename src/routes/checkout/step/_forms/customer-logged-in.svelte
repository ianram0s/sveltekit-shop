...
<div class="bg-muted/50 border-border mb-6 rounded-lg border p-4">
    <div class="flex items-center justify-between">
        ...
        <Button variant="outline" size="sm" onclick={() => goto('/my-account/profile')} class="cursor-pointer">
            Edit Profile
        </Button>
    </div>
</div>
...
<form method="post" action="?/validateCustomer" use:enhance onsubmit={() => (isProcessing = true)}>
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div>
            <label for="firstName" class="text-foreground mb-2 block text-sm font-medium">First Name *</label>
            <input
                id="firstName"
                name="firstName"
        ...
        <div>
            <label for="lastName" class="text-foreground mb-2 block text-sm font-medium">Last Name *</label>
            <input
                id="lastName"
                name="lastName"
        ...
        <div>
            <label for="phone" class="text-foreground mb-2 block text-sm font-medium">Phone Number *</label>
            <input
                id="phone"
                name="phone"
                type="tel"
