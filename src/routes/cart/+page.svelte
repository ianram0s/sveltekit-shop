<script lang="ts">
    ...
    function handleQuantityChange(productId: string, delta: number, selectedColor?: string, selectedSize?: string) {
    ...
    function handleRemoveItem(productId: string, selectedColor?: string, selectedSize?: string, productTitle?: string) {
        itemToRemove = {
            productId,
            selectedColor,
            selectedSize,
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {#if !cartState.isLoaded}
            <div class="flex flex-col items-center justify-center py-16 text-center">
                <div class="border-primary mb-4 h-8 w-8 animate-spin rounded-full border-4 border-t-transparent"></div>
        ...
        {:else}
            <div class="w-full">
                <h1 class="font-integral text-foreground mb-6 text-[2rem] font-bold uppercase lg:text-[2.5rem]">
                    Your Cart
                </h1>
                                        ...
                                        <div class="flex h-full flex-col">
                                            ...
                                            <div class="text-foreground mt-1 flex flex-col text-xs lg:text-sm">
                                                {#if item.selectedSize}
                                                    <span
                                                        >Size: <span class="text-muted-foreground"
                                                ...
                                                {#if item.selectedColor}
                                                    <span
                                                        >Color: <span class="text-muted-foreground"
    ...
    <AlertDialog.Root bind:open={showRemoveDialog}>
        <AlertDialog.Content>
            ...
            <AlertDialog.Footer>
                ...
                <AlertDialog.Action class="cursor-pointer" onclick={confirmRemoveItem}>Remove Item</AlertDialog.Action>
            </AlertDialog.Footer>
        </AlertDialog.Content>
    </AlertDialog.Root>
</div>
